...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center px-4 pb-16 bg-secondary pt-25">
      <motion.div
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-accent tracking-tight">Welcome back</h1>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                <Link href="#" className="text-[10px] font-bold text-primary hover:text-primary/70 transition-colors">Forgot?</Link>
              </div>
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-muted/40 hover:text-muted transition-colors"
                >
            ...
            >
              {isLoading
                ...
                : <span className="flex items-center gap-2">Sign In <ArrowRight className="size-3.5" /></span>
              }
            </Button>
          </form>
