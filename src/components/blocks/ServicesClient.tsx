          ...
          >
            ...
            <div className="relative z-10 max-w-3xl mx-auto space-y-6 sm:space-y-8 md:space-y-10">
               ...
               <div className="pt-2 sm:pt-4">
                  <Button asChild size="lg" className="h-14 sm:h-16 md:h-18 px-8 sm:px-10 md:px-14 rounded-xl md:rounded-2xl bg-white text-accent hover:bg-primary hover:text-white transition-all duration-500 shadow-2xl font-black uppercase tracking-wider sm:tracking-widest text-[10px] sm:text-xs">
